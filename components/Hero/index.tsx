			...
			<div className="flex">
				{data && (
					<div>
						...
						<h1 className="lg:hidden fixed left-0 top-1/2 -translate-y-1/2 font-extrabold font-mono italic text-[var(--color-primary)] text-4xl md:text-6xl mix-blend-multiply z-50 [writing-mode:vertical-lr] rotate-360 origin-center">
						...
						<h1 className="hidden lg:block fixed bottom-0 left-0 font-extrabold font-mono italic text-[var(--color-primary)] text-8xl mix-blend-multiply z-50">
							__<a target="_blank" style={{mixBlendMode:'overlay'}} className="mix-blend-overlay hover:mix-blend-exclusion hover:bg-white hover:text-[var(--color-accent)] hover:duration-300" href={data.external_urls?.spotify}>{data.display_name}</a>_UNWRAPPED__
						</h1>
